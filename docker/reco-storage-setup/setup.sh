...
mongo --host shard2-r0 --eval "rs.initiate(
  {
    _id : 'shard2set',
    members: [
      { _id : 0, host : 'shard2-r0:27017' },
      { _id : 1, host : 'shard2-r1:27017' },
      { _id : 2, host : 'shard2-r2:27017' }
    ]
  }
)"
...
mongo --host reco-storage-router \
    --eval "sh.addShard('shard0set/shard0-r0:27017')"

mongo --host reco-storage-router \
    --eval "sh.addShard('shard1set/shard1-r0:27017')"

mongo --host reco-storage-router \
    --eval "sh.addShard('shard2set/shard2-r0:27017')"
